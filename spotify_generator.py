...
def main():
    print("============================================================================================")
    print("                                    create by Goatherd                                      ")
    print("============================================================================================")
    print("                 using python spotify_generator.py -n amount -o output file                 ")
    print("============================================================================================")

def getRandomString(lenght):
    pool = string.ascii_lowercase+string.digits
    return "".join(random.choice(pool) for i in range(lenght))
...
def Generate():
    ...
    headers = {"Accept-Encoding": "gzip",
             ...
             "User-Agent": "Spotify/8.6.84 iOS/14.8.1 (iPhone12,1)",
             "Spotify-App-Version": "8.6.84",
    ...
    if r.status_code==200:
        if r.json()['status']==1:
            return (True, nick+":"+r.json()["username"]+":"+email+":"+password)
        else:
